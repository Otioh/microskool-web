...
function Profile() {
  ...
  const getcamp = () => {
    ...
    campuses.forEach((camp) => {
      list.push({ value: camp.name + "---" + camp.acro, label: camp.name + "---" + camp.acro })
    })
              ...
              <div className='card shadow'>
                ...
                <div className='card-body'>
                  ...
                  {edit ? <Modal config={{ align: 'flex-end', justify: 'left' }} header={'Update Your Profile'} body={<>
                    ...
                    <TurboSelect options={mycampuses} onChange={(e) => {
                      console.log(e.value)
                    }} />
                    {/* <TurboSelect options={departments} onChange={(e) => {
                      console.log(e.value)
                    }} /> */}
                    <select className='form-select' onChange={(e) => {
